...
func (m *MockDAO) CreateRefundResource(dao *models.RefundResourceDao) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRefundResource", dao)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockDAOMockRecorder) CreateRefundResource(dao interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRefundResource", reflect.TypeOf((*MockDAO)(nil).CreateRefundResource), dao)
}
