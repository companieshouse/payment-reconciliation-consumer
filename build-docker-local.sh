...
COMPOSE="${COMPOSE:-payment-reconciliation-consumer}"
SEARCH_ROOT=$(pwd)
MAX_DEPTH=5
DEPTH=0
COMPOSE_DIR=""
...
cp ./ecs-image-build/docker_start.sh ./ecs-image-build/app/docker_start.sh
cp ./assets/product_code.yml ./ecs-image-build/app/product_code.yml
